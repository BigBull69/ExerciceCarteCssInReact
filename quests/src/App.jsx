...
const fishList = [
...

  {
      ...
      descrition: "Le scalaire haut Pterophyllum altum est un poisson d'eau douce recherché en aquarium pour sa forme majestueuse qui le différencie du Scalaire commun. Ce cichlidé d'Amérique du Sud, de bonne taille, demande un volume d'élevage d'au moins 450 litres pour le bien-être d'un groupe de 6 poissons."
  },
